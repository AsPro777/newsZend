    ...
    'access_filter' => [
        'controllers' => [
            ...
            Controller\AjaxController::class => [
                ...
                ['actions' => ['mainPageCitysList', 'mainPageSearch', 'mainPageMinPrices', 'mainPageSearchById', 'mainPageSearchProviderAnother', 'mainPageSearchNearestTime', 'mainPageReisDetail', 'mainPageReisDetailProviderAnother','getCountry', 'getDocType', 'isHasAccount'], 'allow' => '*'],
                // Allow authorized users to visit action
                ['actions' => '*', 'allow' => '1'],
                ['actions' => '*', 'allow' => '2'],
                ['actions' => '*', 'allow' => '3'],
