<?php
$waagregator = filter_var($waagregator, FILTER_VALIDATE_BOOLEAN);
$waagregator = $waagregator?"checked":"";
...
return <<<S
    <div class="panel tpl" data-node="webaccess">
          ...
          <div class="panel-body">
            ...
            <div class="row view-if-access {$hidden}">
                <div class="col-md-6">
                    В список управления веб-агентами у перевозчиков
                </div>
                <div class="col-md-3">                    
                    <input name="waagregator" type="checkbox" {$waagregator}>
                </div>
            </div>
