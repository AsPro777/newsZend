...
$("div.panel.tpl select[name='grazhd']").typeheadOnSelect({    
    remote:true,
    url:'/ajax/get-country',        
});
$("div.panel.tpl select[name='grazhd']").closest("div").find("button.btn").css({"margin-top":"4px", "height":"34px"});
$("div.panel.tpl select[name='grazhd']").closest("div").find("input[name='__grazhd-typeheadOnSelect']").attr("name", "grazhd_txt");
